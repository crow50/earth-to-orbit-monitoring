...
- If `docker compose run --rm --build db-migrate` fails, deployment should be considered **failed**; fix migrations first. (Runtime services no longer attempt schema bootstrap.)
